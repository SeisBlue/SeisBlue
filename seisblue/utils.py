...
class Config:
    ...
    def __init__(self, workspace=os.path.expanduser("~"), initialize=False):
        if initialize:
            self.generate_config(workspace)
    ...
    def load_config(self, workspace=os.path.expanduser("~")):
        ...
        with open(config_file, 'r') as file:
            ...
            self.seisan = config['SEISAN_TOP']
            self.associate = config['Associate']
    ...
    def generate_config(workspace=os.path.expanduser('~')):
        config = {
            ...
            'SEISAN_TOP': '/opt/seismo',
            'Associate': os.path.join(workspace, 'Associate'),
        }
