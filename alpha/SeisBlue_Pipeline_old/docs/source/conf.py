...
# seisblue_pipeline documentation build
...
from seisblue_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "seisblue_pipeline"
author = "Kedro"
...
htmlhelp_basename = "seisblue_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "seisblue_pipeline.tex",
        "seisblue_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "seisblue_pipeline",
        "Project seisblue_pipeline codebase.",
        "Data-Science",
    )
]
