...
ax.scatter(HL_station[0], HL_station[1], label='HL 2017 station',
           transform=ccrs.PlateCarree(), color='#FBC02D', edgecolors='k', marker='v', linewidth=0.5, s=60)
...
#            transform=ccrs.PlateCarree(), color='#c72c2c', edgecolors='k', marker='v', linewidth=0.5, s=60)
...
config = get_config()
plt.savefig(os.path.join(config['GEOM_ROOT'], 'HL17_map.svg'), format='svg', dpi=500)
